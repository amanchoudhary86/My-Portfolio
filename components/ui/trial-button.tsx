    ...
    return (
        ...
        .shiny-custom-styles {
          ...
          background: conic-gradient(
              ...
              transparent,
              var(--button-color) var(--gradient-percent),
              var(--gradient-shine) calc(var(--gradient-percent) * 2),
              var(--button-color) calc(var(--gradient-percent) * 3),
        ...
        .shiny-custom-styles::after {
          ...
          width: 100%;
          aspect-ratio: 1;
          background: linear-gradient(-50deg, transparent, var(--button-color), transparent);
        ...
        .shiny-custom-styles span::before {
          ...
          width: var(--size);
          height: var(--size);
          box-shadow: inset 0 -1ex 2rem 4px var(--button-color);
          opacity: 0;
